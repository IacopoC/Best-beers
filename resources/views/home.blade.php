        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-7">
                            <h1 class="display-4 text-white mt-5 mb-2">Benvenuto in Best Beers</h1>
                            <p class="text-white">Per vedere tutte le birre disponibili, naviga il sito web</p>
                        </div>
                    </div>
                </div>
            </div>
