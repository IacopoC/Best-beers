        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-7">
                            <h1 class="display-4 text-white mt-5 mb-2">Beer saved!</h1>
    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <p>Go back to see other beers you want to drink/save. <a href="{{ url('beers/1') }}">Beers</a></p>
            </div>
            <div class="col-md-6">
